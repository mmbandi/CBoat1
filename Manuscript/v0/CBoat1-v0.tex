...
%Fig2b: |v(t)| vs. t (long-time transient)

%Fig3a: Schematic for Saikat's model
%Fig3b: Convection PIV snapshot

%Fig4a: speed vs. time (steady-state)
%Fig4b: Speed power spectrum (2Hz oscillation peak)
%Fig4c: Speed power spectrum with SDS.
